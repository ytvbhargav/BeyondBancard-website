...
**D-053 · Footer v2, modelled on Helcim's footer (requested 17 Sept 2026).** Amends the D-006 footer bullet and the PRD §8.4 layout. Contact data and disclosures are unchanged; the footer now links every existing menu item.
