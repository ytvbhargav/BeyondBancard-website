...
export const industryImages: Record<string, IndustryImage[]> = {
  ...
  adult: [
    { src: "/industries/adult-1.webp", alt: "A pink and blue swirl on black" },
    { src: "/industries/adult-2.webp", alt: "Purple and pink gradient waves" },
    { src: "/industries/adult-3.webp", alt: "Deep blue and purple flowing shapes" },
  ],
  gaming: [
  ...
  "travel-payment-solutions": [
    { src: "/industries/travel-payment-solutions-1.webp", alt: "An aircraft at the gate, seen through a terminal window" },
